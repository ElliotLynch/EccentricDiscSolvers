import numpy as np
from . import EccentricDiscGamma2_2D #as ied
...
## Ideally want to inherit from a common Solver class

class EccentricDiscGamma2_2DSolver( EccentricDiscGamma2_2D ):
  ...
  def __init__( self ):
   ...
   EccentricDiscGamma2_2D.__init__(self) 
  ...
  def solve(self,setSol=True,emax=None):
    ...
    if emax!=None:
      ...
      res = opt.newton(self.shoot_once,omega00)
...
if __name__ == '__main__':
  ...
  solver=EccentricDiscGamma2_2DSolver()
