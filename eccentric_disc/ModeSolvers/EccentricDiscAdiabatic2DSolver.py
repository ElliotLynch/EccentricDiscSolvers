import numpy as np
from . import EccentricDiscAdiabatic2D #as ied
...
class EccentricDiscAdiabatic2DSolver( EccentricDiscAdiabatic2D ):
  ...
  def __init__( self ):
   ...
   EccentricDiscAdiabatic2D.__init__(self) 
...
if __name__ == '__main__':
  ...
  solver=EccentricAdiabaticSolver()
