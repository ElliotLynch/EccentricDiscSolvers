import numpy as np
from . import EccentricDiscIsoMHD_2D
...
class EccentricDiscIsoMHD_2DSolver( EccentricDiscIsoMHD_2D ):
  ...
  def __init__( self ):
    ...
    EccentricDiscIsoMHD_2D.__init__(self) 
...
if __name__ == '__main__':
  ...
  solver=EccentricDiscIsoMHD_2DSolver()
